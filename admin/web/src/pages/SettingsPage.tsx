      ...
      <div className="settings-grid">
        <div className="panel">
          <div className="panel-head">
            <h2>Admin 服务</h2>
            <span className="chart-hint">修改 admin.yaml 后需重启</span>
          </div>
          <div className="panel-body settings-body">
            <SettingsRow label="配置文件">
              {data?.admin.config_file ? <PathValue path={data.admin.config_file} /> : '—'}
            </SettingsRow>
        ...
        <div className="panel">
          ...
          <div className="panel-body settings-body">
            ...
            <p className="settings-note">
              清空样例数据：<code>rm -f examples/admin-console/admin.db</code> 后重启 admin（空库会
              bootstrap seed）。
            </p>
          </div>
        </div>
