    ...
    return (
      <div className="panel metrics-empty">
        <p className="empty-hint">
          暂无访问日志数据。请在 <code>admin.yaml</code> 配置 <code>ingress.log_path</code>，并确保{' '}
          <code>access.log</code> 有内容（运行 <code>ingress run</code> 产生流量，或使用{' '}
          <code>examples/admin-console</code> 样例文件）。
        </p>
      </div>
    )
  }
