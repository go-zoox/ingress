          ...
          '/guide/': [
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Runtime Scenarios', link: '/guide/scenarios' },
          ...
          '/examples/': [
            {
              ...
              items: [
                ...
                { text: 'Scenarios', link: '/examples/scenarios' },
          ...
          '/zh/guide/': [
            ...
            },
            {
              ...
              items: [
                ...
                { text: '运行场景', link: '/zh/guide/scenarios' },
          ...
          '/zh/examples/': [
            {
              ...
              items: [
                ...
                { text: '运行场景', link: '/zh/examples/scenarios' },
